...
import controller.SaladeaulaAlunoController;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class InterfaceSaladeaulaAluno extends JFrame {

    private DefaultTableModel model;
    private SaladeaulaAlunoController controller;
    private String nomeUsuario;

    public InterfaceSaladeaulaAluno(String nomeUsuario, SaladeaulaAlunoController controller) {
        this.controller = controller;
        this.nomeUsuario = nomeUsuario; 

        setTitle("Sala de Aula - Aluno");
    ...
    private void setupHeader(String nomeUsuario) {
        ...
        JLabel tituloLabel = new JLabel("Membros Matéria");
        tituloLabel.setFont(new Font("Cabin", Font.BOLD, 42));
        tituloLabel.setForeground(Color.BLACK);
        tituloLabel.setBounds(400, 85, 500, 80); // Centralizado no painel
    ...
    private void setupTable() {
        String[] colunas = {"IdUsuario", "Nome", "Identificação", "Curso", "Email"};
