...
import controller.VisualizarAtividadesProfessorController;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class InterfaceVisualizarAtividadesProfessor extends JFrame {

    private DefaultTableModel model;
    private VisualizarAtividadesProfessorController controller;

    public InterfaceVisualizarAtividadesProfessor(String nomeUsuario, VisualizarAtividadesProfessorController controller) {
        this.controller = controller; 

        setTitle("Visualizar Atividades Encaminhadas");
    ...
    private void setupHeader(String nomeUsuario) {
        ...
        JLabel messageLabel = new JLabel("Atividades Encaminhadas", JLabel.CENTER);
        ...
        voltarButton.addActionListener(e -> {
            dispose();
            controller.voltarParaTelaInicial(nomeUsuario);
        });
    ...
    private void setupTable() {
        ...
        String[] colunas = {"IdMateria", "Matéria", "Nome da Atividade", "Pergunta", "Data de Entrega", "Nota"};
        ...
        controller.carregarAtividades(model);
    }
}
