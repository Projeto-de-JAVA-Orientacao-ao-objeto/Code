...
import controller.MembrosMateriaProfessorController;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class InterfaceMembrosMateriaProfessor extends JFrame {

    private DefaultTableModel model;
    private MembrosMateriaProfessorController controller;
    private String nomeUsuario;  // Definir a variável nomeUsuario

    public InterfaceMembrosMateriaProfessor(String nomeUsuario, MembrosMateriaProfessorController controller) {
        this.nomeUsuario = nomeUsuario;  // Atribuir o valor de nomeUsuario ao campo da classe
        this.controller = controller;

        setTitle("Membros da Matéria");
    ...
    private void setupHeader() {
        ...
        JLabel messageLabel = new JLabel("Membros Matéria", JLabel.CENTER);
        ...
        voltarButton.addActionListener(e -> {
            dispose();
            controller.voltar(nomeUsuario);  // Passa nomeUsuario corretamente para o controller
        });
    ...
    private void setupTable() {
        ...
        String[] colunas = {"IdUsuario", "Nome do Aluno", "Identificação", "Curso", "Email"};
        ...
        // Agora, chame o controller para preencher a tabela com os dados dos membros
        controller.listarMembros(model, nomeUsuario);
    }
}
