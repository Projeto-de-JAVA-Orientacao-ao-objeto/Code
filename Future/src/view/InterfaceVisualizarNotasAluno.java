...
import controller.VisualizarNotasAlunoController;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class InterfaceVisualizarNotasAluno extends JFrame {

    private DefaultTableModel model;
    private VisualizarNotasAlunoController controller;

    public InterfaceVisualizarNotasAluno(String nomeUsuario, VisualizarNotasAlunoController controller) {
    ...
    private void setupTable(String nomeUsuario) {
        ...
        String[] colunas = {"Nome da Atividade", "Nota", "Nota do Aluno", "Porcentagem (%)"};
        ...
        controller.carregarNotas(nomeUsuario, model);
