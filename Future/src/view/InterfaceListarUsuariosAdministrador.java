...
public class InterfaceListarUsuariosAdministrador extends JFrame {

    private DefaultTableModel model;
    private ListarUsuariosController controller;

    public InterfaceListarUsuariosAdministrador(String nomeUsuario, ListarUsuariosController controller) {
    ...
    private void setupHeader(String nomeUsuario) {
        ...
        JLabel messageLabel = new JLabel("Lista de usuários cadastrados", JLabel.CENTER);
    ...
    private void setupTable() {
        ...
        String[] colunas = {"IdUsuario", "Nome", "Usuario", "Senha", "Identificação", "Email", "Telefone", "IdCurso", "Curso", "IdMateria", "Materia"};
