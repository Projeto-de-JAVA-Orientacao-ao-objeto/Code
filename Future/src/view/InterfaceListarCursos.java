...
public class InterfaceListarCursos extends JFrame {

    private DefaultTableModel model;
    private ListarCursosController controller;

    public InterfaceListarCursos(String nomeAdministrador, ListarCursosController controller) {
        ...
        setupHeader(nomeAdministrador);
        setupTable();

        setVisible(true);
    }

    private void setupHeader(String nomeAdministrador) {
        ...
        voltarButton.addActionListener(e -> {
            dispose();
            controller.voltar(nomeAdministrador);
        });

        headerPanel.add(logoLabel);
        headerPanel.add(voltarButton);

        JLabel messageLabel = new JLabel("Lista de cursos cadastrados", JLabel.CENTER);
    ...
    private void setupTable() {
        ...
        String[] colunas = {"IdCurso", "IdMateria", "Curso", "Materia", "Modulo"};
