...
public class MembrosMateriaProfessorDatabase {

    public List<MembrosMateriaProfessorModel> carregarMembros(String nomeUsuario) {
        List<MembrosMateriaProfessorModel> membrosList = new ArrayList<>();
            ...
            try (PreparedStatement stmtMateria = connection.prepareStatement(sqlMateria)) {
                ...
                if (rsMateria.next()) {
                    ...
                    try (PreparedStatement stmtAlunos = connection.prepareStatement(sqlAlunos)) {
                        ...
                        while (rsAlunos.next()) {
                            MembrosMateriaProfessorModel membro = new MembrosMateriaProfessorModel();
